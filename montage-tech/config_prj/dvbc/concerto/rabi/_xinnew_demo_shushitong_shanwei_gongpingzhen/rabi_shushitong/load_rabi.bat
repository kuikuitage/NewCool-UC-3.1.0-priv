...
@SET PRJ_CUSTOMER_NAME=xinnew_demo_shushitong_shanwei_gongpingzhen
@SET PRJ_CFG_NAME=rabi
...
@cp -R ../../../../../../prj/dvbc/%PRJ_NAME%/customer/%PRJ_CUSTOMER_NAME%/binary %PRJ_CFG_NAME%/%PRJ_CONFIG%/
