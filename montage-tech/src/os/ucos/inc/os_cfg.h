...
#define OS_LOWEST_PRIO           63    /* 63Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 63!                            */

#define OS_MAX_EVENTS             200   /* 200 Max. number of event control blocks in your application ...  */
                                       /* ... MUST be > 0                                              */
