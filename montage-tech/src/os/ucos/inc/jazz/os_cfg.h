 ...
 * File : os_cfg.h
 * By   : Jean J. Labrosse
 * Modify By : Fengqinghua For IS15xx  2006-11-21
 ********************************************************************************************************/

/*********************************************************************************************************
 *                                         ISOSys V1.0 CONFIGURATION
 ********************************************************************************************************/

#ifndef _OS_CFG_H_
#define _OS_CFG_H_
                                       /* ---------------------- MISCELLANEOUS ----------------------- */
/* scale : enable OS_ARG_CHK_EN for sem object */
...
/*lu_yuefei 加大*/
#define OS_MAX_EVENTS           254    /* Max. number of event control blocks in your application ...  */
                                       /* ... MUST be > 0                                              */
...
/*lu_yuefei 2007-4-10 防止溢出和意外阻塞*/
#define OS_TICKS_FROM_MS(x)	((x) >= 65535*1000/OS_TICKS_PER_SEC ? 65534:((x)+9)*OS_TICKS_PER_SEC/1000)
/* In Millisecond	       */
...
#define OS_SEM_RESET_EN           1    /*    Include code for OSSemReset()                             */
...
typedef unsigned long    OS_FLAGS;   /* Date type for event flag bits (8, 16 or 32 bits)  */
