...
OS_EXT  INT8U             OSStuffingBytes1[128];
OS_EXT  INT8U             OSRdyGrp;                        /* Ready list group                         */
OS_EXT  INT8U             OSStuffingBytes2[128];
OS_EXT  INT8U             OSRdyTbl[OS_RDY_TBL_SIZE];       /* Table of tasks which are ready to run    */
OS_EXT  INT8U             OSStuffingBytes3[128];
...
OS_FLAGS      OSFlagPend(OS_FLAG_GRP *pgrp, OS_FLAGS flags, INT8U wait_type, INT16U timeout, INT8U *err,OS_FLAGS *flags_rdy);
...
#if OS_SEM_RESET_EN > 0
INT16U        OSSemReset(OS_EVENT *pevent);
#endif
...
#error  "os_cfg.h, Missing OS_SEM_EN: Enable (1) or Disable (0) code generation for SEMAPHORES"
    ...
    #ifndef OS_SEM_RESET_EN
    #error  "os_cfg.h, Missing OS_SEM_RESET_EN: Include code for OSSemReset()"
    #endif
