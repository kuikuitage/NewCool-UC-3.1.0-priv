...
#define  OS_STAT_PEND_EXCEPT_SEM  (OS_STAT_MBOX | OS_STAT_Q | OS_STAT_MUTEX | OS_STAT_FLAG)
/*
*********************************************************************************************************
*                                        OS_EVENT types
*********************************************************************************************************
...
typedef struct {
  /*!
    Type of event control block (see OS_EVENT_TYPE_???)
    */
    INT8U   OSEventType;
    /*!
...
typedef struct {
    ...
    INT8U   OSEventGrp;            
    /*!
      Mutex value (0 = used, 1 = available)
      */
    INT8U   OSValue;           
    /*!
    ...
    INT8U   OSOwnerPrio; 
    /*!
      Priority Inheritance Priority or 0xFF if no owner
      */
    INT8U   OSMutexPIP;                     
} OS_MUTEX_DATA;
#endif
...
#if OS_TASK_STAT_EN > 0
OS_EXT  INT8             OSCPUUsage;               /* Percentage of CPU used                          */
...
OS_FLAGS      OSFlagPend(OS_FLAG_GRP *pgrp, OS_FLAGS flags, INT8U wait_type, INT16U timeout, INT8U *err, OS_FLAGS *flag_rdy);
