...
#define OS_LOWEST_PRIO           254u   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            500u   /* Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS              128u   /* Max. number of Event Flag Groups    in your application      */
...
#define OS_MAX_TASKS             254u   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TICKS_FROM_SEC(x)    ((x)*OS_TICKS_PER_SEC)      /* Calculate Time: In Second   */
#define OS_TICKS_FROM_MS(x)     ((x)*OS_TICKS_PER_SEC/1000)   /* In Millisecond        */

                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    4096u   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   4096u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   4096u   /* Idle       task stack size (# of OS_STK wide entries)        */
