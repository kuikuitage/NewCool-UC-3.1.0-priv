...
#define DN_RF_RSSI_AMP_GAIN_REG   0x009F
#define DIG_RSSITH_REG            0x0084
...
MXL_STATUS MxL_CheckIfFreqIsInLUT(UINT32 freqMHz);
MXL_STATUS GetMCNSSD(UINT8 I2cSlaveAddr, UINT8 RegCode, UINT32 *data);
