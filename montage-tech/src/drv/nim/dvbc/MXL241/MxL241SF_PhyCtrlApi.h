...
/* MxL24xSF MMS float and int calculation controled by user */
/* However, MxL24xSF driver supports only the conditional compile */
//#define __MXL_INTEGER_CALC_STATISTICS__

//#define CUSTOMER_SPECIFIC_SET_1 
/******************************************************************************
...
typedef enum
{
  ...
  MXL_DEMOD_EQUALIZER_FILTER_CFG, // Internal
  MXL_DEMOD_DBG_AGC_SELECT_CFG,   // Internal
  MXL_DEMOD_DBG_AGC_SETPOINT_CFG, // Internal
  ...
  MXL_DEMOD_DBG_CURRENT_BW_REQ,   // Internal
  ...
  MXL_TUNER_DBG_IQOUT_CFG,        // Internal
  MXL_TUNER_DBG_AGC_SETPOINT_CFG, // Internal
  MXL_TUNER_DBG_GAIN_FREEZE_CFG, // Internal

  MXL_TUNER_LOCK_STATUS_REQ, 
  MXL_TUNER_DBG_LOCK_STATUS_REQ,  // Internal

  MXL_TUNER_RF_RX_PWR_REQ,

  MXL_TUNER_AGC_SETTINGS_REQ,
  MXL_TUNER_DBG_SENSOR_TEMP_REQ,  // Internal
...
typedef struct
{
  ...
  MPEG_CLK_FMT_E  MpegClkSource;       /* IN, Internal  */
#ifdef  _MXL_FPGA_ 
