...
MXL_STATUS MxL_CheckIfFreqIsInLUT(UINT32 freqMHz)
{
  ...
  if (   ((freqMHz >= 44) && (freqMHz <= 49))
      || ((freqMHz >= 56) && (freqMHz <= 66))
      || ((freqMHz >= 83) && (freqMHz <= 99))
      || ((freqMHz >= 111) && (freqMHz <= 133))
      || ((freqMHz >= 167) && (freqMHz <= 199))
      || ((freqMHz >= 222) && (freqMHz <= 266))
      || ((freqMHz >= 333) && (freqMHz <= 399))
      || ((freqMHz >= 444) && (freqMHz <= 533))
      || ((freqMHz >= 667) && (freqMHz <= 799))) status = MXL_TRUE;
