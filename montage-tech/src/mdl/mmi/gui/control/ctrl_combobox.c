                                ...
                                u16 sbar_gap)
{
  ...
  u16 list_width = 0, list_height = 0 , list_top = 0;
  ...
  list_top = (rc_cbox.top + list_height ) > 720 ? ((rc_cbox.top - rc_root.top) - list_height):(rc_cbox.top - rc_root.top);

  p_cbox->p_droplist = ctrl_create_ctrl(CTRL_LIST, IDC_CBOX_DROPLIST,
    rc_cbox.left - rc_root.left, list_top,
