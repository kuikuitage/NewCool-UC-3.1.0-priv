...
BOOL parse_record_info_idx(rec_info_t *p_rec_info, u16 *p_idx_name)
{
  ...
  p_rec_info->audio_key_even_len = p_st_rec_info->audio_key_even_len;
  memcpy(p_rec_info->audio_key_even,
         p_st_rec_info->audio_key_even,
         p_rec_info->audio_key_even_len);
  p_rec_info->audio_key_odd_len  = p_st_rec_info->audio_key_odd_len;
  memcpy(p_rec_info->audio_key_odd,
         p_st_rec_info->audio_key_odd,
         p_rec_info->audio_key_odd_len);
  p_rec_info->video_key_even_len = p_st_rec_info->video_key_even_len;
  memcpy(p_rec_info->video_key_even,
         p_st_rec_info->video_key_even,
         p_rec_info->video_key_even_len);
  p_rec_info->video_key_odd_len  = p_st_rec_info->video_key_odd_len;
  memcpy(p_rec_info->video_key_odd,
         p_st_rec_info->video_key_odd,
         p_rec_info->video_key_odd_len);
