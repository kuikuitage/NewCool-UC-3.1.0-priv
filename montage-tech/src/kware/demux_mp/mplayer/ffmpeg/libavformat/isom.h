...
typedef struct MOVSMless {
    unsigned int stts_index_chunk;
    unsigned int stsc_index_chunk;
    unsigned int stss_index_chunk;
    unsigned int stps_index_chunk;
    unsigned int rap_group_index ;
    unsigned int rap_group_sample;
...
typedef struct MOVStreamContext {
    ...
    unsigned int stts_sample;
    int nb_index_entries;
    int nb_index_entries1;
    int nb_index_entries2;
    int64_t current_dts;
    MOVSMless *movst_mless;
    int movst_mless_num;
    int64_t  begin_dts;
    int64_t  end_dts;
    int64_t  first_dts;
