...
#define MAX_NB_SEGMENT_RUN_TABLE_BOXES 5
#define MAX_NB_FRAGMENT_RUN_TABLE_BOXES 5

//#define MAX_NB_SEGMENT_RUN_ENTRIES 1024
//#define MAX_NB_FRAGMENT_RUN_ENTRIES 1024
#define MAX_NB_SEGMENT_RUN_ENTRIES 256
#define MAX_NB_FRAGMENT_RUN_ENTRIES 256
