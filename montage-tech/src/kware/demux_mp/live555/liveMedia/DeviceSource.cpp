...
#include <GroupsockHelper.hh> // for "gettimeofday_replace()"
...
void DeviceSource::deliverFrame() {
  ...
  //         by calling "gettimeofday_replace()".
...
#else
  gettimeofday_replace(&fPresentationTime, NULL); // If you have a more accurate time - e.g., from an encoder - then use that instead.
#endif  
