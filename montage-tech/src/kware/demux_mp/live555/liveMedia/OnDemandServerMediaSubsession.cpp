...
OnDemandServerMediaSubsession::sdpLines() {
  if (fSDPLines == NULL) {
    ...
    Medium::closeMedium(dummyRTPSink);
...
void OnDemandServerMediaSubsession::closeStreamSource(FramedSource *inputSource) {
  Medium::closeMedium(inputSource);
}
...
void StreamState::reclaim() {
  ...
  Medium::closeMedium(fRTCPInstance) /* will send a RTCP BYE */; fRTCPInstance = NULL;
  Medium::closeMedium(fRTPSink); fRTPSink = NULL;
  Medium::closeMedium(fUDPSink); fUDPSink = NULL;
