...
DelayQueue::DelayQueue()
  ...
  //OS_PRINTF("[%s]ETERNITY s %d us %d!\n",__func__,ETERNITY.seconds(),
	//	ETERNITY.useconds());
  //OS_PRINTF("[%s]------------start!\n",__func__);
  ...
  //OS_PRINTF("[%s]fDeltaTimeRemaining s %d us %d!\n",__func__,curEntry->fDeltaTimeRemaining.seconds(),
//		curEntry->fDeltaTimeRemaining.useconds());
...
void DelayQueue::synchronize() {
  ...
  //OS_PRINTF("[%s]timeNow s %d us %d!\n",__func__,timeNow.seconds(),
  //timeNow.useconds());

    //OS_PRINTF("[%s]fLastSyncTime s %d us %d!\n",__func__,fLastSyncTime.seconds(),
  //fLastSyncTime.useconds());
  ...
  //OS_PRINTF("[%s]timeSinceLastSync s %d us %d!\n",__func__,timeSinceLastSync.seconds(),
  //	timeSinceLastSync.useconds());
  fLastSyncTime = timeNow;
...
EventTime TimeNow() {
 ...
 //OS_PRINTF("[%s]------------start!\n",__func__);	
 #ifdef __LINUX__
    //gettimeofday(&tvNow, NULL);//peacer del
