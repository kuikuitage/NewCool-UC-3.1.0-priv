...
void ui_init_ca(void)
{
  ...
  fw_register_ap_msghost(APP_CA, ROOT_ID_FACTORY_TEST);
...
void ui_release_ca(void)
{
  ...
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_FACTORY_TEST);
...
BEGIN_AP_EVTMAP(ui_ca_evtmap)
  ...
  CONVERT_EVENT(CAS_EVT_PAIRED_SET, MSG_CA_PAIRE_SET)
...
//  CONVERT_EVENT(CAS_EVT_IPP_PROG_NOTIFY,MSG_CA_IPP_PROG_NOTIFY)
 ...
 CONVERT_EVENT(CAS_EVT_MAIL_DEL_RESULT, MSG_CA_MAIL_DEL_RESULT) 
  ...
  CONVERT_EVENT(CAS_EVT_UPGRADE_FREQ,MSG_CA_UPGRADE_FREQ)
  CONVERT_EVENT(CAS_EVT_VOD_AUTH_INVALID,MSG_CA_VOD_AUTH)
  CONVERT_EVENT(CAS_EVT_ADS_MESSAGE,MSG_ADS_MESSAGE)
