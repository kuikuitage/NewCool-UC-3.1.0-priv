...
RET_CODE open_ca_burse_dlg(u32 para1, u32 para2)
{
  ...
  u32 charge = 10;
  #endif
//  OS_PRINTF("ui_get_ecm_msg() ======= %d\n", ui_get_ecm_msg());
  //if(ui_get_ecm_msg())//ecm msg is showing ,emm msg don't need show
   // return ERR_FAILURE;
  ...
  text_set_content_by_strid(p_title, IDS_SLOT_INFO);
  ...
  p_icon = ctrl_create_ctrl(CTRL_BMAP, IDC_ICON,
                   ...
                   40, 40,
                   p_cont, 0);
  bmap_set_content_by_id(p_icon, IM_ARROW_L);
