...
enum comm_ctrl_idc
{
  ...
  IDC_COMM_EXT_NUM,
  IDC_COMM_EXT_SEL,
  IDC_COMM_CTRL_SELECT,
};

/* coordinate */
#define COMM_CTRL_H                 (30)
#define COMM_CTRL_OX                (50)
...
/* rect style  */
#define RSI_COMM_CONT_SH         RSI_ITEM_1_SH
#define RSI_COMM_CONT_HL         RSI_ITEM_1_HL
#define RSI_COMM_CONT_GRAY       RSI_ITEM_3_SH

#define RSI_COMM_TXT_SH          RSI_PBACK
#define RSI_COMM_TXT_HL          RSI_PBACK
#define RSI_COMM_TXT_GRAY        RSI_PBACK

#define RSI_COMM_SELECT_SH       RSI_LEFT_RIGHT_SH
#define RSI_COMM_SELECT_HL       RSI_LEFT_RIGHT_HL
#define RSI_COMM_SELECT_GRAY     RSI_LEFT_RIGHT_GRAY

#define RSI_COMM_TIMEDIT_SH      RSI_LEFT_RIGHT_SH
#define RSI_COMM_TIMEDIT_HL      RSI_LEFT_RIGHT_HL
#define RSI_COMM_TIMEDIT_GRAY    RSI_LEFT_RIGHT_GRAY
...
#define RSI_COMM_NUMEDIT_SH      RSI_PBACK
#define RSI_COMM_NUMEDIT_HL      RSI_PBACK
#define RSI_COMM_NUMEDIT_GRAY    RSI_PBACK

#define RSI_COMM_PWDEDIT_SH      RSI_PBACK
#define RSI_COMM_PWDEDIT_HL      RSI_PBACK
#define RSI_COMM_PWDEDIT_GRAY    RSI_PBACK

#define RSI_COMM_T9EDIT_SH       RSI_PBACK//RSI_ITEM_1_SH
#define RSI_COMM_T9EDIT_HL       RSI_PBACK//RSI_ITEM_1_HL
#define RSI_COMM_T9EDIT_GRAY     RSI_PBACK//RSI_ITEM_1_SH

/* font style */
#define FSI_COMM_TXT_SH          FSI_WHITE
#define FSI_COMM_TXT_HL          FSI_BLACK
#define FSI_COMM_TXT_GRAY        FSI_BLACK

#define FSI_COMM_CTRL_SH         FSI_WHITE
#define FSI_COMM_CTRL_HL         FSI_BLACK
#define FSI_COMM_CTRL_GRAY       FSI_BLACK
