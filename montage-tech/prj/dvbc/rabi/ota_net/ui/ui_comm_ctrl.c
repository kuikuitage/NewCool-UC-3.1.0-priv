...
static void ui_comm_droplist_creat(control_t *p_ctrl_cbox, u16 page)
{
  ...
  cbox_droplist_set_rstyle(cbox, RSI_BOX2, RSI_BOX2, RSI_BOX2);
...
void ui_comm_static_set_font(control_t *cont,
                                 u32 n_fstyle,
                                 u32 h_fstyle,
                                 u32 g_fstyle)
{
  ...
  p_ctrl = ctrl_get_child_by_id(cont, IDC_COMM_CTRL);
  text_set_font_style(p_ctrl, n_fstyle, h_fstyle, g_fstyle);
}

void ui_comm_ipedit_set_font(control_t *cont,
                                 u32 n_fstyle,
                                 u32 h_fstyle,
                                 u32 g_fstyle)
{
  ...
  p_ctrl = ctrl_get_child_by_id(cont, IDC_COMM_CTRL);
  ipbox_set_font_style(p_ctrl, n_fstyle, h_fstyle, g_fstyle);
}
/*********************************************************************
 * COMMON NUMSEL
 *********************************************************************/
