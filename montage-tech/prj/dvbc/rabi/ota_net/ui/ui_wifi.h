...
#define WIFI_CONT_Y        55//((SCREEN_HEIGHT- WIFI_CONT_H) / 2) + 35
#define WIFI_CONT_W        1040
#define WIFI_CONT_H        605//580//(2 * TIMER_TITLE_Y + TIMER_TITLE_H + TIMER_ITEM_CNT * (TIMER_ITEM_H + TIMER_ITEM_V_GAP) + TIMER_BTN_H + 2*TIMER_ITEM_V_GAP)
...
//connect status left 
#define WIFI_STATUS_LEFT_X       380
#define WIFI_STATUS_LEFT_Y       0
#define WIFI_STATUS_LEFT_W       120
#define WIFI_STATUS_LEFT_H       WIFI_STATUS_CONT_H

//connect status 
#define WIFI_STATUS_X       WIFI_STATUS_LEFT_X + WIFI_STATUS_LEFT_W
#define WIFI_STATUS_Y       0
#define WIFI_STATUS_W       140//WIFI_STATUS_CONT_W - 2*WIFI_STATUS_X -100
