...
{
  {BLOCK_SUB_32BIT_BUFFER, SUB_32BIT_BUFFER_ADDR, SUB_32BIT_BUFFER_SIZE, MEM_BLOCK_SHARED},
  {BLOCK_OSD1_32BIT_BUFFER, OSD1_32BIT_BUFFER_ADDR, OSD1_32BIT_BUFFER_SIZE, MEM_BLOCK_NOT_SHARED},
  {BLOCK_OSD0_32BIT_BUFFER, OSD0_32BIT_BUFFER_ADDR, OSD0_32BIT_BUFFER_SIZE, MEM_BLOCK_NOT_SHARED},
  {BLOCK_STP_BUFFER, STP_32BIT_BUFFER_ADDR, STP_32BIT_BUFFER_SIZE, MEM_BLOCK_NOT_SHARED},
  {BLOCK_EPG_BUFFER, EPG_BUFFER_ADDR, EPG_BUFFER_SIZE, MEM_BLOCK_NOT_SHARED},
  {BLOCK_AV_BUFFER, AV_BUFFER_ADDR, AV_BUFFER_SIZE, MEM_BLOCK_NOT_SHARED}
};
