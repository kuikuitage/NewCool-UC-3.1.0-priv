...
/*005|     |--+*/ SID_IPTV_SEARCH_SEARCH_WORD_NORMAL,
/*006|     |--+*/ SID_IPTV_SEARCH_SEARCH_WORD,
/*007|        |--+*/ SID_IPTV_SEARCH_SEARCH_NORMAL,
/*008|        |--+*/ SID_IPTV_SEARCH_SEARCH_REQ,
};
...
{/*004|  |--+ SID_IPTV_SEARCH_SEARCH */
    ...
    {SID_INTERNAL, MSG_DELETE, NULL, (SFUNA) ui_iptvsearch_on_delete},
    {SID_INTERNAL, MSG_TIME_UPDATE, NULL, (SFUNA) on_iptvsearch_update_searchWord},
};

static const STATE_TRANS_T SttIptvSearch_SearchWordNormal[] =
{/*005|  |--+ SID_IPTV_SEARCH_SEARCH_WORD_NORMAL */
    {SID_INTERNAL, MSG_SELECT, (SFUNC) StcIptvSearch_is_on_vdolist, (SFUNA) StaIptvSearch_search_on_vdolist_selected},
};

static const STATE_TRANS_T SttIptvSearch_SearchWord[] =
{/*006|  |--+ SID_IPTV_SEARCH_SEARCH_WORD */
    {SID_INTERNAL, MSG_IPTV_EVT_NEW_SEARCH_WORD_ARRIVE, NULL, (SFUNA) StaIptvSearch_search_on_searchWord_arrive},
    {SID_INTERNAL, MSG_IPTV_EVT_GET_SEARCH_WORD_FAIL, NULL, (SFUNA) StaIptvSearch_search_on_get_searchWord_fail},
};
...
{/*007|     |--+ SID_IPTV_SEARCH_SEARCH_NORMAL */
    ...
    {SID_INTERNAL, MSG_SELECT, (SFUNC) StcIptvSearch_is_on_vdolist, (SFUNA) StaIptvSearch_search_on_vdolist_selected},
    {SID_INTERNAL, MSG_EXIT, (SFUNC) StcIptvSearch_is_on_vdolist, (SFUNA) StaIptvSearch_search_on_vdolist_to_search_word},
};
...
/*004|  |--+ SID_IPTV_SEARCH_SEARCH */ {SID_IPTV_SEARCH_ACTIVE, SID_IPTV_SEARCH_SEARCH_WORD_NORMAL, (SFUNE) SenIptvSearch_Search, (SFUNE) SexIptvSearch_Search, SttIptvSearch_Search, sizeof(SttIptvSearch_Search)/sizeof(STATE_TRANS_T)},
/*005|     |--+ SID_IPTV_SEARCH_SEARCH_WORD_NORMAL */ {SID_IPTV_SEARCH_SEARCH, SID_NULL, (SFUNE) SenIptvSearch_SearchWordNormal, (SFUNE) SexIptvSearch_SearchWordNormal, SttIptvSearch_SearchWordNormal, sizeof(SttIptvSearch_SearchWordNormal)/sizeof(STATE_TRANS_T)},
/*006|     |--+ SID_IPTV_SEARCH_SEARCH_WORD */ {SID_IPTV_SEARCH_SEARCH, SID_IPTV_SEARCH_SEARCH_NORMAL, (SFUNE) SenIptvSearch_SearchWord, (SFUNE) SexIptvSearch_SearchWord, SttIptvSearch_SearchWord, sizeof(SttIptvSearch_SearchWord)/sizeof(STATE_TRANS_T)},
/*007|        |--+ SID_IPTV_SEARCH_SEARCH_NORMAL */ {SID_IPTV_SEARCH_SEARCH_WORD, SID_NULL, (SFUNE) SenIptvSearch_SearchNormal, (SFUNE) SexIptvSearch_SearchNormal, SttIptvSearch_SearchNormal, sizeof(SttIptvSearch_SearchNormal)/sizeof(STATE_TRANS_T)},
/*008|        |--+ SID_IPTV_SEARCH_SEARCH_REQ */ {SID_IPTV_SEARCH_SEARCH_WORD, SID_NULL, (SFUNE) SenIptvSearch_SearchReq, (SFUNE) SexIptvSearch_SearchReq, SttIptvSearch_SearchReq, sizeof(SttIptvSearch_SearchReq)/sizeof(STATE_TRANS_T)},
};
