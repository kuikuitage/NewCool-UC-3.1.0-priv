...
/*017|     |--+*/ SID_CLASSIC_DESCRIPTION,
/*018|        |--+*/ SID_CLASSIC_COLLECT_REQ,
/*019|        |--+*/ SID_CLASSIC_COLLECT_LIST,
/*020|        |--+*/ SID_CLASSIC_COLLECT_URL_REQ,
/*021|     |--+*/ SID_CLASSIC_RESOLUTION,
/*022|  |--+*/ SID_CLASSIC_INIT_FAILED,
/*023|  |--+*/ SID_CLASSIC_DEINIT,
};
...
static void SenClassic_Description(void);
static BOOL    StcClassic_is_on_collect_list(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_collectlist_exit(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static void SexClassic_Description(void);
static void SenClassic_CollectReq(void);
static STATEID StaClassic_descrptn_on_new_collect_list_arrived(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_get_collect_list_failed(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static void SexClassic_CollectReq(void);
static void SenClassic_CollectList(void);
static BOOL    StcClassic_is_on_collect_list(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_collectlist_focus_key_hldr(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static BOOL    StcClassic_is_on_collect_list(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_change_page(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static BOOL    StcClassic_is_on_collect_list(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_collectlist_selected(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static void SexClassic_CollectList(void);
static void SenClassic_CollectUrlReq(void);
static STATEID StaClassic_vdo_popu_on_newplayurl_arrived(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_descrptn_on_subwindow_exit(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static STATEID StaClassic_vdo_popu_on_get_playurl_failed(control_t *ctrl, u16 msg, u32 para1, u32 para2);
static void SexClassic_CollectUrlReq(void);
...
{/*010|        |--+ SID_CLASSIC_VDO_REQ */
    ...
    {SID_INTERNAL, MSG_NETMEDIA_NEW_PAGE_VDO_ARRIVED, NULL, (SFUNA) StaClassic_vdo_on_newpagevdo_arrived},
...
static const STATE_TRANS_T SttClassic_Description[] =
{/*017|     |--+ SID_CLASSIC_DESCRIPTION */
    {SID_INTERNAL, MSG_EXIT, (SFUNC) StcClassic_is_on_collect_list, (SFUNA) StaClassic_descrptn_on_collectlist_exit},
};

static const STATE_TRANS_T SttClassic_CollectReq[] =
{/*018|        |--+ SID_CLASSIC_COLLECT_REQ */
    {SID_INTERNAL, MSG_NETMEDIA_NEW_COLLECTION_LIST_ARRIVED, NULL, (SFUNA) StaClassic_descrptn_on_new_collect_list_arrived},
    {SID_INTERNAL, MSG_NETMEDIA_GET_COLLECTION_LIST_FAILED, NULL, (SFUNA) StaClassic_descrptn_on_get_collect_list_failed},
    {SID_CLASSIC_COLLECT_LIST, MSG_CLOSE_CFMDLG_NTF, NULL, NULL},
};

static const STATE_TRANS_T SttClassic_CollectList[] =
{/*019|        |--+ SID_CLASSIC_COLLECT_LIST */
    {SID_INTERNAL, MSG_FOCUS_KEY, (SFUNC) StcClassic_is_on_collect_list, (SFUNA) StaClassic_descrptn_on_collectlist_focus_key_hldr},
    {SID_INTERNAL, MSG_PAGE_KEY, (SFUNC) StcClassic_is_on_collect_list, (SFUNA) StaClassic_descrptn_on_change_page},
    {SID_INTERNAL, MSG_SELECT, (SFUNC) StcClassic_is_on_collect_list, (SFUNA) StaClassic_descrptn_on_collectlist_selected},
};

static const STATE_TRANS_T SttClassic_CollectUrlReq[] =
{/*020|        |--+ SID_CLASSIC_COLLECT_URL_REQ */
    {SID_INTERNAL, MSG_NETMEDIA_NEW_PLAY_URLS_ARRIVED, NULL, (SFUNA) StaClassic_vdo_popu_on_newplayurl_arrived},
    {SID_CLASSIC_COLLECT_LIST, MSG_UPDATE, NULL, (SFUNA) StaClassic_descrptn_on_subwindow_exit},
    {SID_INTERNAL, MSG_NETMEDIA_GET_PLAY_URLS_FAILED, NULL, (SFUNA) StaClassic_vdo_popu_on_get_playurl_failed},
    {SID_CLASSIC_COLLECT_LIST, MSG_CLOSE_CFMDLG_NTF, NULL, NULL},
};
...
/*017|     |--+ SID_CLASSIC_DESCRIPTION */ {SID_CLASSIC_RESOURCE, SID_CLASSIC_COLLECT_REQ, (SFUNE) SenClassic_Description, (SFUNE) SexClassic_Description, SttClassic_Description, sizeof(SttClassic_Description)/sizeof(STATE_TRANS_T)},
/*018|        |--+ SID_CLASSIC_COLLECT_REQ */ {SID_CLASSIC_DESCRIPTION, SID_NULL, (SFUNE) SenClassic_CollectReq, (SFUNE) SexClassic_CollectReq, SttClassic_CollectReq, sizeof(SttClassic_CollectReq)/sizeof(STATE_TRANS_T)},
/*019|        |--+ SID_CLASSIC_COLLECT_LIST */ {SID_CLASSIC_DESCRIPTION, SID_NULL, (SFUNE) SenClassic_CollectList, (SFUNE) SexClassic_CollectList, SttClassic_CollectList, sizeof(SttClassic_CollectList)/sizeof(STATE_TRANS_T)},
/*020|        |--+ SID_CLASSIC_COLLECT_URL_REQ */ {SID_CLASSIC_DESCRIPTION, SID_NULL, (SFUNE) SenClassic_CollectUrlReq, (SFUNE) SexClassic_CollectUrlReq, SttClassic_CollectUrlReq, sizeof(SttClassic_CollectUrlReq)/sizeof(STATE_TRANS_T)},
/*021|     |--+ SID_CLASSIC_RESOLUTION */ {SID_CLASSIC_RESOURCE, SID_NULL, (SFUNE) SenClassic_Resolution, (SFUNE) SexClassic_Resolution, SttClassic_Resolution, sizeof(SttClassic_Resolution)/sizeof(STATE_TRANS_T)},
/*022|  |--+ SID_CLASSIC_INIT_FAILED */ {SID_CLASSIC_ACTIVE, SID_NULL, (SFUNE) SenClassic_InitFailed, (SFUNE) SexClassic_InitFailed, NULL, sizeof(NULL)/sizeof(STATE_TRANS_T)},
/*023|  |--+ SID_CLASSIC_DEINIT */ {SID_CLASSIC_ACTIVE, SID_NULL, (SFUNE) SenClassic_Deinit, (SFUNE) SexClassic_Deinit, SttClassic_Deinit, sizeof(SttClassic_Deinit)/sizeof(STATE_TRANS_T)},
};
