...
static RET_CODE _ui_text_encode_list_update(control_t* p_ctrl, u16 start, u16 size, u32 context)
{
    ...
    { 
        ...
        list_set_field_content_by_ascstr(p_ctrl, i, 2, pp_text_encode[i]);
...
static void _ui_text_encode_create_list(control_t *p_cont)
{
    ...
    ctrl_set_rstyle(p_list, RSI_POPUP_BG, RSI_POPUP_BG, RSI_POPUP_BG);
    ctrl_set_keymap(p_list, _ui_text_encode_keymap);
    ctrl_set_proc(p_list, _ui_text_encode_proc);

    ctrl_set_mrect(p_list, UI_TEXT_ENCODE_LIST_MID_L, UI_TEXT_ENCODE_LIST_MID_T,
		UI_TEXT_ENCODE_LIST_MID_W+UI_TEXT_ENCODE_LIST_MID_L, UI_TEXT_ENCODE_LIST_MID_H+UI_TEXT_ENCODE_LIST_MID_T);
	list_set_item_interval(p_list, UI_TEXT_ENCODE_LIST_ITEM_V_GAP);                 
...
static void _ui_text_encode_create_title(control_t *p_cont)
{
    ...
    text_set_font_style(p_ttl, FSI_WHITE, FSI_WHITE, FSI_WHITE);
