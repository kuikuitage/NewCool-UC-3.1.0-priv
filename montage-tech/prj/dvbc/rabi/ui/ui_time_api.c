...
void ui_time_init(void)
{
  ...
  fw_register_ap_msghost(APP_TIME, ROOT_ID_VEPG);
  ...
  fw_register_ap_msghost(APP_TIME, ROOT_ID_IPTV_SEARCH); 
}
...
void ui_time_release(void)
{
  ...
  fw_unregister_ap_msghost(APP_TIME, ROOT_ID_VEPG); 
  ...
  fw_unregister_ap_msghost(APP_TIME, ROOT_ID_IPTV_SEARCH);
}
