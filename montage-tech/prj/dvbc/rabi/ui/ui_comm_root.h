...
#ifdef DTMB_PROJECT
#define ROOT_SIGN_BAR_CNT              (2)
#else
#define ROOT_SIGN_BAR_CNT              (3)
#endif

/* coordinate */
#define ROOT_SIGN_BAR_CONT_X         (120)
#define ROOT_SIGN_BAR_CONT_W         (1040)
#define ROOT_SIGN_CONT_W             (996)
#define ROOT_SIGN_CONT_H             (36*ROOT_SIGN_BAR_CNT)
#define ROOT_SIGN_CONT_GAP           (0)//4

#define ROOT_SIGN_BAR_STXT_X         (22)//(10)//50
#define ROOT_SIGN_BAR_STXT_Y         (0)
#ifdef DTMB_PROJECT
#define ROOT_SIGN_BAR_STXT_W         (210)
#else
#define ROOT_SIGN_BAR_STXT_W         (150)
#endif
#define ROOT_SIGN_BAR_STXT_H         (36)//30

#define ROOT_SIGN_BAR_PERCENT_X      (ROOT_SIGN_BAR_STXT_X + ROOT_SIGN_BAR_STXT_W)
#define ROOT_SIGN_BAR_PERCENT_Y      ROOT_SIGN_BAR_STXT_Y
#define ROOT_SIGN_BAR_PERCENT_W      (90)
#define ROOT_SIGN_BAR_PERCENT_H      ROOT_SIGN_BAR_STXT_H

#define ROOT_SIGN_BAR_X              (ROOT_SIGN_BAR_PERCENT_X + ROOT_SIGN_BAR_PERCENT_W)
#define ROOT_SIGN_BAR_Y              (ROOT_SIGN_BAR_PERCENT_Y +  ((ROOT_SIGN_BAR_STXT_H - ROOT_SIGN_BAR_H) >> 1))
//#define ROOT_SIGN_BAR_W                (COMM_BG_W - 2 * ROOT_SIGN_BAR_STXT_X - ROOT_SIGN_BAR_STXT_W - ROOT_SIGN_BAR_PERCENT_W)
#define ROOT_SIGN_BAR_W              (ROOT_SIGN_CONT_W - ROOT_SIGN_BAR_PERCENT_X - ROOT_SIGN_BAR_PERCENT_W)
...
/***************************************************
*xsys_set right window
***************************************************/
//right window
#define RIGHT_ROOT_X				SYS_LEFT_CONT_W	
#define RIGHT_ROOT_Y				SYS_LEFT_CONT_Y
#define RIGHT_ROOT_W				SYS_RIGHT_CONT_W
#define RIGHT_ROOT_H				SYS_LEFT_CONT_H

/***************  right root single start  **********************/
#define RIGHT_ROOT_SIGN_BAR_CONT_X         (60)
#define RIGHT_ROOT_SIGN_BAR_CONT_W         (RIGHT_ROOT_W-2*RIGHT_ROOT_SIGN_BAR_CONT_X)
#define RIGHT_ROOT_SIGN_CONT_H             (108)
#define RIGHT_ROOT_SIGN_BAR_STXT_X         (22)//(10)//50
#define RIGHT_ROOT_SIGN_BAR_STXT_W         (150)//200
#define RIGHT_ROOT_SIGN_BAR_STXT_H         (36)//30

#define RIGHT_ROOT_SIGN_BAR_PERCENT_X      (RIGHT_ROOT_SIGN_BAR_STXT_X + RIGHT_ROOT_SIGN_BAR_STXT_W)
#define RIGHT_ROOT_SIGN_BAR_PERCENT_W      (90)
#define RIGHT_ROOT_SIGN_BAR_PERCENT_H      RIGHT_ROOT_SIGN_BAR_STXT_H

#define RIGHT_ROOT_SIGN_BAR_X              (RIGHT_ROOT_SIGN_BAR_PERCENT_X + RIGHT_ROOT_SIGN_BAR_PERCENT_W)
#define RIGHT_ROOT_SIGN_BAR_Y              ((RIGHT_ROOT_SIGN_BAR_STXT_H - RIGHT_ROOT_SIGN_BAR_H) >> 1)
#define RIGHT_ROOT_SIGN_BAR_W              (RIGHT_ROOT_SIGN_BAR_CONT_W - RIGHT_ROOT_SIGN_BAR_PERCENT_X - RIGHT_ROOT_SIGN_BAR_PERCENT_W-RIGHT_ROOT_SIGN_BAR_STXT_X)
#define RIGHT_ROOT_SIGN_BAR_H              (16)
/*****************  right root single end  *******************/

control_t *ui_comm_right_root_create(u8 root_id, u16 parent_root_id,
												obj_attr_t obj_attr, u32 reserve);
control_t *ui_comm_root_cont_create(u8 root_id,u8 parent_root,
                               			u16 x,u16 y,u16 w,u16 h, 
                               			obj_attr_t attr,u32 reserve);
