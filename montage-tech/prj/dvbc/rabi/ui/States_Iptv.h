 ...
 ** All rights reserved.
 **
 ** Document Name: States_Iptv.h
 ** Abstract     :
 **
 ** Current Ver  : 
 ** Author       : shaowenrong
 ** Date         : 2014-10-28 10:55:13
 **
...
{/*005|  |--+ SID_IPTV_RESOURCE */
    {SID_INTERNAL, MSG_FOCUS_KEY, (SFUNC) StcIptv_is_on_vdolist, (SFUNA) StaIptv_resource_on_vdolist_focus_key_hldr},
    {SID_INTERNAL, MSG_PAGE_KEY, (SFUNC) StcIptv_is_on_vdolist, (SFUNA) StaIptv_resource_on_change_page},
    {SID_INTERNAL, MSG_FOCUS_KEY, (SFUNC) StcIptv_is_on_catlist, (SFUNA) StaIptv_resource_on_catlist_focus_key_hldr},
    {SID_INTERNAL, MSG_FOCUS_KEY, (SFUNC) StcIptv_is_on_reslist, (SFUNA) StaIptv_resource_on_reslist_focus_key_hldr},
    ...
    {SID_INTERNAL, MSG_FOCUS_KEY, (SFUNC) StcIptv_is_on_filter, (SFUNA) StaIptv_resource_on_filter_focus_key_hldr},
    {SID_INTERNAL, MSG_SELECT, (SFUNC) StcIptv_is_on_filter, (SFUNA) StaIptv_resource_on_filter_selected},
    {SID_INTERNAL, MSG_EXIT, (SFUNC) StcIptv_is_on_filter, (SFUNA) StaIptv_resource_on_filter_exit},
