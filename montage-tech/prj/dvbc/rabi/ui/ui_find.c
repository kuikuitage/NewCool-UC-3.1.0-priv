...
RET_CODE open_find(u32 para1, u32 para2)
{
  ...
  p_cont = fw_create_mainwin((u8)(ROOT_ID_FIND),
  ...
  p_list_cont = ctrl_create_ctrl(CTRL_TEXT, IDC_FIND_LIST_CONT, 
                                ...
                                FIND_LIST_CONT_W, FIND_LIST_CONT_H, 
                                p_cont, 0);
  ...
  list_set_item_interval(p_list, FIND_ITEM_V_GAP);
  ...
  ui_comm_help_create_for_pop_dlg(&help_data, p_list_cont);
  ...
  sbar_set_mid_rstyle(p_sbar, RSI_FIND_SBAR_MID, RSI_FIND_SBAR_MID, RSI_FIND_SBAR_MID);
  ctrl_set_mrect(p_sbar, 0, FIND_SBAR_VERTEX_GAP, FIND_SBAR_W, FIND_SBAR_H - FIND_SBAR_VERTEX_GAP);
