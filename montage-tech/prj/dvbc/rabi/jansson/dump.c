...
static int dump_string_nocare_code_type(const char *str, int ascii, json_dump_callback_t dump, void *data)
{
                   ...
                   json_dump_callback_t dump, void *data)
{
    ...
    switch(json_typeof(json)) {
        ...
        case JSON_STRING:
#if 	NC_DEFINED		
    	return dump_string_nocare_code_type(json_string_value(json), ascii, dump, data);
#else
