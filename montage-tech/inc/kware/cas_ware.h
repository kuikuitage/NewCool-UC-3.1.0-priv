...
/*!
  The cas max freq number
  */
#define CAS_MAX_FREQ_NUM  200
...
/*!
	PASSWORD_ERROR
*/
   CAS_E_PASSWORD_ERROR,
/*!
    can not play in the ZONE
*/
   CAS_E_ZONE_DISPLAY,
/*!
   ABVCA: ota info get
...
*/
   CAS_C_RESUME_OSD,
   CAS_C_HIDE_OSD_BOTTOM,
   CAS_C_HIDE_OSD_TOP,
/*!
	No network authorization
*/
   CAS_E_VOD_AUTH_INVALID,
   /*!
	No network authorization
*/
   CAS_C_ADS_MESSAGE,
...
typedef struct
{
	...
	u32 uiFrequency;
	u32 uiSymbolrate;
}cas_upgrade_freq_info_t;

typedef struct
{
    u16  upgrade_freq_num;
    cas_upgrade_freq_info_t upgrade_freq_info[CAS_MAX_FREQ_NUM];
}cas_upgrade_freq_t;
...
#define ERR_CAS_EXT_START   ((s32)-100)

enum RET_CODE_CAS_EXT {
	CAS_SUCESS = SUCCESS,			/*执行成功*/
	CAS_FAILED = ERR_CAS_EXT_START, /*执行失败*/
	CAS_ERR_NOCARD,		/*智能卡未插入*/
	CAS_ERR_INVALID_CARD, 	/*智能卡无效*/
	CAS_ERR_INVALID_ECMPID, 	/*ECM Pid 错误*/
	CAS_ERR_INVALID_EMMPID,	/*EMM Pid 错误*/
	CAS_ERR_NOENTITLE, 		/*没有授权*/
	CAS_ERR_PIN_ERROR, 		/*Pin码错误*/
	CAS_ERR_STB_PAIR_FAILED,	/*机卡配对失败*/
	CAS_ERR_INIT_ERROR,		/*CA初始化失败*/
	CAS_ERR_CARD_VER_ERROR,		/*该版本卡不支持该命令*/
};
